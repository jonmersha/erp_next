  ...
  return (
    <div className="space-y-6">
      ...
      <motion.div 
        ...
        className="bg-[var(--color-surface)] border border-[var(--color-border)] shadow-sm p-6 flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8 min-h-[7rem] h-auto md:h-28 overflow-hidden relative text-center md:text-left"
      >
        {/* Banner Background */}
        {company?.bannerUrl && (
          <div className="absolute inset-0 z-0">
            ...
            <img 
              ...
              src={apiService.getImageUrl(company.bannerUrl)} 
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-4 md:gap-6 shrink-0 z-10 relative w-full md:w-fit max-w-full bg-[var(--color-surface)]/80 backdrop-blur-md p-4 md:p-6 rounded-2xl border border-[var(--color-border)]/50 shadow-sm text-center md:text-left">
          <div className="w-16 h-16 md:w-20 md:h-20 bg-[var(--color-bg)] border border-[var(--color-border)] flex items-center justify-center shrink-0 shadow-sm relative z-10 rounded-xl overflow-hidden">
            {company?.logoUrl ? (
              <img crossOrigin="anonymous" src={apiService.getImageUrl(company.logoUrl)} alt={company.name} className="w-full h-full object-cover" referrerPolicy="no-referrer" />
            ) : (
          ...
          <div className="relative z-10 w-full flex flex-col items-center md:items-start">
            ...
            <div className="flex flex-wrap justify-center md:justify-start items-center gap-4 mt-2 text-sm text-[var(--color-text)]/90 drop-shadow-sm">
              {company?.address && (
