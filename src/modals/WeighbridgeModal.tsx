...
interface Props {
  ...
  defaultReferenceId?: string; // Pre-select this PO when opened from lifecycle tracker
}

const WeighbridgeModal: React.FC<Props> = ({ isOpen, onClose, onSuccess, purchaseOrders, log, defaultReferenceId }) => {
