...
export const submitPurchaseOrder = async (orderId: string) => {
  return await apiService.post(`procurement/orders/${orderId}/submit`, {});
};

export const getPOLifecycle = async (orderId: string) => {
  return await apiService.get(`procurement/orders/${orderId}/lifecycle`);
};

export const approvePurchaseOrder = async (orderId: string, approverId: string) => {
  return await apiService.post(`procurement/orders/${orderId}/approve`, { approverId });
};

export const approveSupplier = async (supplierId: string, approverId: string) => {
  return await apiService.post(`procurement/suppliers/${supplierId}/approve`, { approverId });
};
...
export const approvePurchaseRequisition = async (prId: string, approverId: string) => {
  return await apiService.post(`purchaseRequisitions/${prId}/approve`, { approverId });
};

export const rejectPurchaseRequisition = async (prId: string) => {
  return await apiService.post(`purchaseRequisitions/${prId}/reject`, {});
};
