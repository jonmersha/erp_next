...
export const approveProductionPlan = async (id: string, approverId: string) => {
  return await apiService.post(`production/plans/${id}/approve`, { approverId });
};

export const rejectProductionPlan = async (id: string, approverId: string, rejectionReason: string) => {
  return await apiService.post(`production/plans/${id}/reject`, { approverId, rejectionReason });
};

export const approveProcurementPlan = async (id: string, approverId: string) => {
  return await apiService.post(`procurement/plans/${id}/approve`, { approverId });
};

export const rejectProcurementPlan = async (id: string, approverId: string, rejectionReason: string) => {
  return await apiService.post(`procurement/plans/${id}/reject`, { approverId, rejectionReason });
};

export const approveSalesPlan = async (id: string, approverId: string) => {
  return await apiService.post(`sales/plans/${id}/approve`, { approverId });
};

export const rejectSalesPlan = async (id: string, approverId: string, rejectionReason: string) => {
  return await apiService.post(`sales/plans/${id}/reject`, { approverId, rejectionReason });
};
